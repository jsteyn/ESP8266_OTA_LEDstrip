  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    request->send(
      ...
      R"(
        ...
        + String(projectTitle) + R"( ESP8266 device on IP )" + String((char *)(WiFi.localIP()).toString().c_str()) +
        R"(</div>
        ...
        R"(</div>
          ...
          <p> To update your code type this into your address bar:<br /> 
            <a href='http://)"
        + String((char *)(WiFi.localIP()).toString().c_str()) + R"(/update' target='_blank'>http://)" + String((char *)(WiFi.localIP()).toString().c_str()) +
        R"(/update</a> <br />
